...
def get_args_parser(subparsers):
    subparsers.add_argument('--batch-size', default=96, type=int, help='Batch size per device')
    subparsers.add_argument('--epochs', default=1, type=int) # base epoch
    subparsers.add_argument('--inc_epochs', default=1, type=int)
    ...
    subparsers.add_argument('--num_tasks', default=9, type=int, help='number of sequential tasks')
    ...
    # Domain-Prompt parameters
    subparsers.add_argument('--use_d_prompt', default=True, type=bool, help='if using G-Prompt')
    subparsers.add_argument('--d_prompt_length', default=10, type=int, help='length of G-Prompt')
    subparsers.add_argument('--d_prompt_layer_idx', default=[0, 1], type=int, nargs = "+", help='the layer index of the G-Prompt')
    subparsers.add_argument('--use_prefix_tune_for_d_prompt', default=True, type=bool, help='if using the prefix tune for G-Prompt')

    # FSCIL-Prompt parameters
    subparsers.add_argument('--use_f_prompt', default=True, type=bool, help='if using the E-Prompt')
    subparsers.add_argument('--f_prompt_layer_idx', default=[2, 3, 4], type=int, nargs = "+", help='the layer index of the E-Prompt')
    subparsers.add_argument('--use_prefix_tune_for_f_prompt', default=True, type=bool, help='if using the prefix tune for E-Prompt')

    # Use prompt pool implement FSCIL-Prompt
    ...
    subparsers.add_argument('--usf_prompt_mask', default=True, type=bool)
    ...
    # Misc parameters
    subparsers.add_argument('--print_freq', type=int, default=30, help = 'The frequency of printing')

    # FSCIL
    subparsers.add_argument('--batch_size_base', type=int, default=25, help='batch_size')
    subparsers.add_argument('--test_batch_size', type=int, default=25)
    subparsers.add_argument('--batch_size_new', type=int, default=0, help='set 0 will use all the availiable training image for new')