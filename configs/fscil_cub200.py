...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--inc_epochs', default=5, type=int)
    # Model parameters
    ...
    subparsers.add_argument('--seed', default=229, type=int)
    ...
    subparsers.add_argument('--num_tasks', default=11, type=int, help='number of sequential tasks')
