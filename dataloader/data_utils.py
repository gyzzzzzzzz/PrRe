...
#它根据传入的参数args，设置数据集相关的配置，并返回更新后的args
...
def get_new_dataloader(args,session,transform_train, transform_val):
    # /home/haomeilan/gyz/PL-FSCIL-master/data/index_list/Split-CIFAR100/session_2.txt
    txt_path = "/home/haomeilan/gyz/PL-FSCIL-master/data/index_list/" + args.dataset + "/session_" + str(session + 1) + '.txt'
    if args.dataset == 'Split-CIFAR100':
